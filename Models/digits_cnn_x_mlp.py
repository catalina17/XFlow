...
def get_model():
	...
	short1_2dto1d = PReLU(name='res1_to_mlp')(short1_2dto1d)

	# MLP to CNN - cross-connections
	x12 = Dense(14*29)(fcMLP)
	x12 = PReLU()(x12)
	x12 = BatchNormalization()(x12)
	x12 = Dropout(0.5)(x12)
	x12 = Reshape((14,29,1))(x12)
	x12 = Deconvolution2D(16, 32, 32, output_shape=(None, 45, 60, 16), border_mode='valid')(x12)
	x12 = PReLU(name='x1_to_cnn')(x12)

	# 1st shortcut (residual connection) from MLP input to CNN
	short1_1dto2d = Dense(14*29)(inputMLP)
	short1_1dto2d = PReLU()(short1_1dto2d)
	short1_1dto2d = BatchNormalization()(short1_1dto2d)
	short1_1dto2d = Dropout(0.25)(short1_1dto2d)
	short1_1dto2d = Reshape((14,29,1))(short1_1dto2d)
	short1_1dto2d = Deconvolution2D(
		16, 32, 32, output_shape=(None, 45, 60, 16), border_mode='valid')(short1_1dto2d)
	short1_1dto2d = PReLU()(short1_1dto2d)
	short1_1dto2d = BatchNormalization(name='res1_to_cnn')(short1_1dto2d)
	...
	short2_2dto1d = PReLU(name='res2_to_mlp')(short2_2dto1d)

	# MLP to CNN - cross-connections
	x12 = Dense(7*15)(fcMLP)
	x12 = PReLU()(x12)
	x12 = BatchNormalization()(x12)
	x12 = Dropout(0.5)(x12)
	x12 = Reshape((7,15,1))(x12)
	x12 = Deconvolution2D(32, 16, 16, output_shape=(None, 22, 30, 32), border_mode='valid')(x12)
	x12 = PReLU(name='x2_to_cnn')(x12)

	# 2nd shortcut (residual connection) from MLP input to CNN
	short2_1dto2d = Dense(7*15)(inputMLP)
	short2_1dto2d = PReLU()(short2_1dto2d)
	short2_1dto2d = BatchNormalization()(short2_1dto2d)
	short2_1dto2d = Dropout(0.5)(short2_1dto2d)
	short2_1dto2d = Reshape((7,15,1))(short2_1dto2d)
	short2_1dto2d = Deconvolution2D(
		32, 16, 16, output_shape=(None, 22, 30, 32), border_mode='valid')(short2_1dto2d)
	short2_1dto2d = PReLU(name='res2_to_cnn')(short2_1dto2d)
